...
public class Janela1 extends javax.swing.JFrame {
    ...
    private void evento_botao(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_evento_botao
        String msg= ((JButton) evt.getSource()).getText();
        String visor= jVisor.getText();
        this.jVisor.setText(visor+msg);
        
        
    }//GEN-LAST:event_evento_botao
