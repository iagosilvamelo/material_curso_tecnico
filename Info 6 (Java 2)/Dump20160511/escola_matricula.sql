...
CREATE TABLE `matricula` (
  ...
  CONSTRAINT `matricula_ibfk_4` FOREIGN KEY (`codaluno`) REFERENCES `aluno` (`codaluno`) ON UPDATE CASCADE,
  CONSTRAINT `matricula_ibfk_5` FOREIGN KEY (`codcurso`) REFERENCES `curso` (`codcurso`) ON UPDATE CASCADE
